 ...
 * @author USER
 */
public class VHrLeaveAccept extends javax.swing.JFrame {

    /**
     * Creates new form VHrLeaveAccept
     */
    public VHrLeaveAccept() {
        initComponents();
    }
    ...
    try (Connection con = MDBConnection.createConnection();
         ...
         ResultSet rst = st.executeQuery("SELECT * FROM eleave WHERE LeaveID = " + orderId)) {
    ...
    private void btn_search1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_search1ActionPerformed
        ...
        try (Connection con = MDBConnection.createConnection();
            Statement st = con.createStatement();
            ResultSet rst = st.executeQuery("SELECT * FROM eleave")) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int leaveID = Integer.parseInt(txt_leave.getText());

        // Check if a valid leave ID is entered
        if (leaveID <= 0) {
            JOptionPane.showMessageDialog(null, "Please enter a valid Leave ID.");
            return; // Exit the method
        }

        // Establish connection and update the status
        try (Connection conn = MDBConnection.createConnection()) {
            // SQL query to update the leave status
            String sql = "UPDATE ELeave SET Status = 'Accepted' WHERE LeaveID = ?";
            ...
            if (updateCount > 0) {
                JOptionPane.showMessageDialog(null, "Leave status updated to Accepted!");
            } else {
                JOptionPane.showMessageDialog(null, "Leave ID not found.");
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error updating leave status: " + ex.getMessage());
        }
        // Get the leave ID from the text field
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VHrLeaveAccept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VHrLeaveAccept().setVisible(true);
            }
        });
    }
