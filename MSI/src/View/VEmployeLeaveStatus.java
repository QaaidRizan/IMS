 ...
 * @author USER
 */
public class VEmployeLeaveStatus extends javax.swing.JFrame {

    /**
     * Creates new form VEmployeLeaveStatus
     */
    public VEmployeLeaveStatus() {
        initComponents();
    }
    ...
    private void txt_displayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_displayActionPerformed
        ...
        if (orderIdText.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Leave ID cannot be empty", "Validation Error", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Invalid Leave ID. Please enter a valid integer.", "Validation Error", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VEmployeLeaveStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VEmployeLeaveStatus().setVisible(true);
            }
        });
    }
