 ...
 * @author USER
 */
public class VCheckStock extends javax.swing.JFrame {

    /**
     * Creates new form VCheakStock
     */
    public VCheckStock() {
        initComponents();
    }
    ...
    private void txt_displayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_displayActionPerformed
        ...
        // Validate the Stock ID input
    String stockIdText = txt_stockid.getText();
    if (stockIdText.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Stock ID cannot be empty", "Validation Error", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    try {
        ...
        JOptionPane.showMessageDialog(null, "Invalid Stock ID. Please enter a valid integer.", "Validation Error", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCheckStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCheckStock().setVisible(true);
            }
        });
    }
