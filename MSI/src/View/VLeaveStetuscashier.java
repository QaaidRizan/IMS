 ...
 * @author USER
 */
public class VLeaveStetuscashier extends javax.swing.JFrame {

    /**
     * Creates new form VLeaveStetuscashier
     */
    public VLeaveStetuscashier() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLeaveStetuscashier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLeaveStetuscashier().setVisible(true);
            }
        });
    }
