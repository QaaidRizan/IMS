 ...
 * @author USER
 */
public class VLeaveStetusStockManager extends javax.swing.JFrame {

    /**
     * Creates new form VLeaveStetusStockManager
     */
    public VLeaveStetusStockManager() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLeaveStetusStockManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLeaveStetusStockManager().setVisible(true);
            }
        });
    }
