 ...
 * @author USER
 */
public class VLeaveStetusSm extends javax.swing.JFrame {

    /**
     * Creates new form VLeaveStetusSm
     */
    public VLeaveStetusSm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLeaveStetusSm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLeaveStetusSm().setVisible(true);
            }
        });
    }
