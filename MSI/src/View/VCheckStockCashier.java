 ...
 * @author moham
 */
public class VCheckStockCashier extends javax.swing.JFrame {

    /**
     * Creates new form VCheckStockCashier
     */
    public VCheckStockCashier() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TextArea.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "StockID", "Qty", "Price", "ProductID", "SupplierID", "StockDate"
            }
        ));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txt_stockid, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(37, 37, 37)
 ...
 String stockIdStr = txt_stockid.getText().trim();

    // Validation: Check if Stock ID is empty
    if (stockIdStr.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Please enter a Stock ID.", "Input Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    // Validation: Check if Stock ID is a valid number
    int stockid;
    try {
        stockid = Integer.parseInt(stockIdStr);
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "Stock ID must be a number.", "Input Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    try (Connection con = MDBConnection.createConnection();
         Statement st = con.createStatement();
         ResultSet rst = st.executeQuery("SELECT * FROM Stock WHERE StockID = " + stockid)) {
        ...
        if (rst.next()) {
            ...
            model.addRow(new Object[]{
                ...
                rst.getInt("SupplierID"),
                rst.getDate("StockDate"),
                rst.getInt("Price")
            });
...
try (Connection con = MDBConnection.createConnection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCheckStockCashier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCheckStockCashier().setVisible(true);
            }
        });
    }
