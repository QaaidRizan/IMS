 ...
 * @author USER
 */
public class VCustomerPayemnt extends javax.swing.JFrame {

    /**
     * Creates new form VCustomerPayemnt
     */
    public VCustomerPayemnt() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Customer Payments");
        ...
        paymentsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PaymentID", "PaymentDate", "OrderID", "PaymentMethod", "Cash", "TotalAmount", "Balance"
            }
        ));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btn_search1, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(btn_search1, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btn_search1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_search1ActionPerformed
       try (Connection con = MDBConnection.createConnection();
         ...
         ResultSet rst = st.executeQuery("SELECT * FROM payments")) {

        // Create a new table model
        DefaultTableModel model = new DefaultTableModel();

        // Add columns to the model based on the payments table
        ...
        while (rst.next()) {
            model.addRow(new Object[]{
                ...
                rst.getInt("Cash"),       // Assuming Cash is stored as double
                rst.getInt("TotalAmount"), // Assuming TotalAmount is stored as double
                rst.getInt("Balance")      // Assuming Balance is stored as double
            });
        }

        // Set the model to the JTable to display data
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCustomerPayemnt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCustomerPayemnt().setVisible(true);
            }
        });
    }
