 ...
 * @author USER
 */
public class VReciveFeedback extends javax.swing.JFrame {

    /**
     * Creates new form VReciveFeedback
     */
    public VReciveFeedback() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TextArea.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FeedbackID", "Date", "Description", "EmployeeID", "EmployeeName"
            }
        ));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txt_orderid, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(37, 37, 37)
    ...
    private void txt_displayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_displayActionPerformed
        ...
        int feedbackid = Integer.parseInt(txt_orderid.getText());

        try (Connection con = MDBConnection.createConnection();
            Statement st = con.createStatement();
            ResultSet rst = st.executeQuery("select * from Feedback where FeedbackID = " + feedbackid)) {
            ...
            if (rst.next()) {
                ...
                JOptionPane.showMessageDialog(null, "FeedbackID not found", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VReciveFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VReciveFeedback().setVisible(true);
            }
        });
    }
